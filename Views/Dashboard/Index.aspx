                                    ...
                                    <div class="d-flex justify-content-between align-items-start gap-2 mb-3">
                                        ...
                                        <div class="d-flex flex-column align-items-end gap-1">
                                            <div class="d-flex align-items-center gap-1">
                                                <button class="btn btn-link p-0 text-primary opacity-50 hover-opacity-100 transition-all border-0 shadow-none d-flex align-items-center justify-content-center" 
                                                        data-bs-toggle="modal" 
                                                        data-bs-target="#lotModal_<%: lot.Id %>" 
