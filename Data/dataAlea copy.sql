...
INSERT INTO dbo.race (nom, dureEclosionOeuf, poidsDefaut, capacitePondetion)
VALUES
    (N'Borboneze', 30, 50, 10);
GO
...
INSERT INTO dbo.lot (creation, nomLot, raceId, nombreInitial, poidsInitiale, prixAchat, lotOeufId, maxCapacitePondetion)
VALUES
    ('2026-01-01 00:00:00', N'Lot 1', 1, 500, 50, 250000.00, NULL, 5000);
GO
...
-- Prix de la nourriture (par gramme)
INSERT INTO dbo.prixVenteRace (creation, raceId, prix)
VALUES
    (GETDATE(), 1, 500);
GO